...
pub use self::light::{
    ...
    scan_light_bytes_with_options_and_sink, scan_light_bytes_with_options_and_sink_and_then,
    ...
    scan_light_file_with_sink, scan_light_shared_bytes_with_encoding_and_options_and_sink,
